...
def Deep_Sloop_Model(repository_path=r"C:/Users/Douglas/PycharmProjects/Deep_Sloop/Datasets/Filtered_90_70_Sloops_Loop_3_22_Seg_20_150_FLOL_split_datasets_010_100mult",
    ...
    # Naming
    custom_expt_name -- A string representing the name of an experiment you are running to interrogate model performance
    custom_expt_var -- A string representing the variable/parameter you are changing in your experiment
    custom_expt_value -- An integer to help you keep track of how are are altering the parameter of interest
    """
